...
LgsExpr* LgsInt::addConst(LgsExpr* left, LgsExpr* right) {
...
LgsExpr* LgsInt::subConst(LgsExpr* left, LgsExpr* right) {
    const auto const1 = left->getConstInt();
    if (!const1) return nullptr;
    const auto const2 = right->getConstInt();
    if (!const2) return nullptr;
...
LgsExpr* LgsInt::mulConst(LgsExpr* left, LgsExpr* right) {
    const auto const1 = left->getConstInt();
    if (!const1) return nullptr;
    const auto const2 = right->getConstInt();
    if (!const2) return nullptr;
...
LgsExpr* LgsInt::divConst(LgsExpr* left, LgsExpr* right) {
    const auto const1 = left->getConstInt();
    if (!const1) return nullptr;
    const auto const2 = right->getConstInt();
    if (!const2) return nullptr;
...
LgsExpr* LgsInt::modConst(LgsExpr* left, LgsExpr* right) {
    const auto const1 = left->getConstInt();
    if (!const1) return nullptr;
    const auto const2 = right->getConstInt();
    if (!const2) return nullptr;
...
LgsExpr* LgsInt::powConst(LgsExpr* left, LgsExpr* right) {
    const auto const1 = left->getConstInt();
    if (!const1) return nullptr;
    const auto const2 = right->getConstInt();
    if (!const2) return nullptr;
...
LgsExpr* LgsInt::bitAndConst(LgsExpr* left, LgsExpr* right) {
    const auto const1 = left->getConstInt();
    if (!const1) return nullptr;
    const auto const2 = right->getConstInt();
    if (!const2) return nullptr;
...
LgsExpr* LgsInt::bitOrConst(LgsExpr* left, LgsExpr* right) {
    const auto const1 = left->getConstInt();
    if (!const1) return nullptr;
    const auto const2 = right->getConstInt();
    if (!const2) return nullptr;
...
LgsExpr* LgsInt::bitXorConst(LgsExpr* left, LgsExpr* right) {
    const auto const1 = left->getConstInt();
    if (!const1) return nullptr;
    const auto const2 = right->getConstInt();
    if (!const2) return nullptr;
...
LgsExpr* LgsInt::lshiftConst(LgsExpr* left, LgsExpr* right) {
    const auto const1 = left->getConstInt();
    if (!const1) return nullptr;
    const auto const2 = right->getConstInt();
    if (!const2) return nullptr;
...
LgsExpr* LgsInt::rshiftConst(LgsExpr* left, LgsExpr* right) {
    const auto const1 = left->getConstInt();
    if (!const1) return nullptr;
    const auto const2 = right->getConstInt();
    if (!const2) return nullptr;
...
LgsExpr* LgsInt::eqConst(LgsExpr* left, LgsExpr* right) {
    const auto const1 = left->getConstInt();
    if (!const1) return nullptr;
    const auto const2 = right->getConstInt();
    if (!const2) return nullptr;
...
LgsExpr* LgsInt::neConst(LgsExpr* left, LgsExpr* right) {
    const auto const1 = left->getConstInt();
    if (!const1) return nullptr;
    const auto const2 = right->getConstInt();
    if (!const2) return nullptr;
...
LgsExpr* LgsInt::ltConst(LgsExpr* left, LgsExpr* right) {
    const auto const1 = left->getConstInt();
    if (!const1) return nullptr;
    const auto const2 = right->getConstInt();
    if (!const2) return nullptr;
...
LgsExpr* LgsInt::gtConst(LgsExpr* left, LgsExpr* right) {
    const auto const1 = left->getConstInt();
    if (!const1) return nullptr;
    const auto const2 = right->getConstInt();
    if (!const2) return nullptr;
...
LgsExpr* LgsInt::geConst(LgsExpr* left, LgsExpr* right) {
    const auto const1 = left->getConstInt();
    if (!const1) return nullptr;
    const auto const2 = right->getConstInt();
    if (!const2) return nullptr;
...
LgsExpr* LgsInt::leConst(LgsExpr* left, LgsExpr* right) {
    const auto const1 = left->getConstInt();
    if (!const1) return nullptr;
    const auto const2 = right->getConstInt();
    if (!const2) return nullptr;
...
LgsExpr* LgsInt::andConst(LgsExpr* left, LgsExpr* right) {
    const auto const1 = left->getConstInt();
    if (!const1) return nullptr;
    const auto const2 = right->getConstInt();
    if (!const2) return nullptr;
...
LgsExpr* LgsInt::orConst(LgsExpr* left, LgsExpr* right) {
    const auto const1 = left->getConstInt();
    if (!const1) return nullptr;
    const auto const2 = right->getConstInt();
    if (!const2) return nullptr;
