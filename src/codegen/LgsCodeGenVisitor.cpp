...
void LgsCodeGenVisitor::generate(const LgsAppConfigs& appConfigs, TargetMachine& targetMachine) {
...
Function* LgsCodeGenVisitor::getThunkFunc(const LgsFuncCall* fc, Type* ctxTy) const {
