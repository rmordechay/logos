...
void LgsForeachLoop::setStrIterVars(LgsLLVM& codeGen, const LgsStr* str) const {
...
void LgsForeachLoop::setArrIterVars(LgsLLVM& codeGen, LgsDArray* arr) const {
    const auto iValue = loadIndex(codeGen);
    if (arr->asSArray()) {
...
void LgsForeachLoop::setMapIterVars(LgsLLVM& codeGen, const LgsIterator& iterator) const {
