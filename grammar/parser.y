...
object_entity:
		object_declaration implements_block enum_declartion object_fields_block object_methods_block_list { $$ = create_object_entity($3, $4, $6, $7) }
	| 	object_declaration object_fields_block object_methods_block_list { $$ = create_object_entity($3, NULL, $4, $5) }
	| 	object_declaration object_fields_block { $$ = create_object_entity($3, NULL, $4, NULL) }
	;
...
unary_expr:
	...
	| 	INTEGER { $$ = create_unary_expr_from_number(UE_INT, yylval.val) }
