...
define ptr @Map_new_Int(i32 noundef %0) #0 {
  ...
  %4 = call ptr @malloc(i64 noundef 24) #6
...
47:                                               ; preds = %19
  ...
  %69 = getelementptr inbounds %struct.HashMap, ptr %68, i32 0, i32 2
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define i64 @Map_len_Map(ptr noundef %0) #0 {
  %2 = alloca ptr, align 8
  store ptr %0, ptr %2, align 8
  %3 = load ptr, ptr %2, align 8
  %4 = getelementptr inbounds %struct.HashMap, ptr %3, i32 0, i32 2
