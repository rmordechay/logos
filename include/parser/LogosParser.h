...
public:
  enum {
    ...
    FOR = 77, FOREVER = 78, FOR_IS_FIRST = 79, FOR_IS_LAST = 80, FOR_I = 81, 
    AND = 82, OR = 83, NOT = 84, IN = 85, LONG = 86, INTEGER = 87, FLOAT = 88, 
    BOOL = 89, NULL_ = 90, IDENTIFIER = 91, STRING = 92, TAG = 93, LINE_COMMENT = 94, 
    BLOCK_COMMENT = 95, WS = 96
  };
