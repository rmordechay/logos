...
inline LgsBaseError E10015{.msg = "Function with name '%s' was found but it doesn't match the parameters.\n\t   Given:    %s\n\t   Expected: %s", .errCode = errCodeStart++};
...
inline LgsBaseError E10034{.msg = "Object '%s' has a method with name '%s' but it doesn't match the parameters.\n\t   Given:    %s\n\t   Expected: %s", .errCode = errCodeStart++};
...
inline LgsBaseError E10051{.msg = "Constant expression '%s' cannot be overwritten.", .errCode = errCodeStart++};
