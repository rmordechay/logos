...
inline LgsBaseMsg E10003{"Index is out of bounds.", errCodeStart++};
...
inline LgsBaseMsg E10033{"Type name must be capitalized. Given: %s.", errCodeStart++};
...
inline LgsBaseMsg E10042{"Expression %s of type %s cannot be sliced.", errCodeStart++};
