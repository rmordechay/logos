...
inline LgsError E10018{.msg = "Expression of type '%s' can not be casted to type '%s'.", .errCode = errCodeStart++};
...
inline LgsError E10032{.msg = "Singleton object '%s' can not be instantiated.", .errCode = errCodeStart++};
...
inline LgsError E10036{.msg = "'%s' can not be indexed with type '%s'.", .errCode = errCodeStart++};
...
inline LgsError E10042{.msg = "Expression '%s' of type '%s' can not be sliced.", .errCode = errCodeStart++};
