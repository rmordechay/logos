...
public:
    ...
    void computeSimpleIf(Module* module);
    void computeComplexIf(Module* module);
    void createElseIfBlocks(Module* module);
    void createElseBlock(Module* module, BasicBlock* elseBlock, BasicBlock* ifEndBlock) const;
    ~LgsIfStmt() override;
};
